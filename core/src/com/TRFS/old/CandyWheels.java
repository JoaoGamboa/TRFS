...
//	
//	public Candy car;//car this wheel belongs to	
...
//	public Body body;
//
//	public CandyWheels (World world, Candy car, float posX, float posY, float width, float length, boolean revolving, boolean powered) {
//		super();
//		this.car = car;
//		this.width = width;
//		this.length = length;
