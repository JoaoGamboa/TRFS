...
//	public List<CandyWheels> wheels;
//	
//	public Candy(World world, float width, float length, Vector2 position,float angle, float power, float maxSteerAngle, float maxSpeed) {
//		super();		
...
//        vertices[0] = new Vector2( 0.2f,   0);
//        vertices[1] = new Vector2( 0.8f, 0.2f);
//        vertices[2] = new Vector2( 0.8f, 0.95f);
//        vertices[3] = new Vector2( 0.3f, 3f);
//        vertices[4] = new Vector2( -0.3f, 3f);
//        vertices[5] = new Vector2( -0.8f, 0.95f);
//        vertices[6] = new Vector2( -0.8f, 0.2f);
//        vertices[7] = new Vector2(-0.2f,  0);
//		carShape.set(vertices);
//		fixtureDef.shape = carShape;
//		this.body.createFixture(fixtureDef);
//		
//		//initialize wheels
//		this.wheels = new ArrayList<CandyWheels>();
//		this.wheels.add(new CandyWheels(world, this, -1f, 2.4f, 0.2f, 0.6f, true,  false)); //top left
//		this.wheels.add(new CandyWheels(world, this, 1f, 2.4f, 0.2f, 0.6f, true,  false)); //top right
//		this.wheels.add(new CandyWheels(world, this, -0.9f, 0.2f, 0.4f, 0.75f, false,  true)); //back left
//		this.wheels.add(new CandyWheels(world, this, 0.9f, 0.2f, 0.4f, 0.75f, false,  true)); //back right
//	}
//	
//	public List<CandyWheels> getPoweredWheels () {
//		List<CandyWheels> poweredWheels = new ArrayList<CandyWheels>();
//		for (CandyWheels wheel:this.wheels) {
//			if (wheel.powered)
...
//
//	
//	public List<CandyWheels> getRevolvingWheels () {
//		List<CandyWheels> revolvingWheels = new ArrayList<CandyWheels>();
//		for (CandyWheels wheel:this.wheels) {
//			if (wheel.revolving)
...
//        for(CandyWheels wheel:this.getRevolvingWheels()) {
...
//        for(CandyWheels wheel:this.getPoweredWheels()){
